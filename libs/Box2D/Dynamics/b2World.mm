...
//			FPBody* body = (FPBody*)b->GetUserData();
			...
			{
//				if(body.isTouchable && body.isBreakable)
//				{
//					DrawShape(s, xf, b2Color(1, 1, 1), core);
//				}
//				else if(body.isStatic)
//				{
//					DrawShape(s, xf, b2Color(241/255, 205/255, 63/255), core);
//				} if(body.isTouchable)
//				{
//					DrawShape(s, xf, b2Color(63/255, 241/255, 93/255), core);
//				}
//				else
//				{
...
//				}
				...
				if(s->IsSensor())
				{
					DrawShape(s, xf, b2Color(0.9f, 0.5f, 0.5f), core);
				}
				else if (b->IsStatic())
				{
